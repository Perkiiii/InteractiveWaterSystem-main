...
- Added the focused runtime/editor assembly boundaries, non-destructive generated hierarchy repair, runtime-owned meshes and materials, and explicit edit/play-mode disposal.
...
- Added rectangular, world-density-derived CRT ripple state with RGHalf/RGFloat fallback, no mipmaps, bounded catch-up, per-second damping, aspect-correct propagation, queued impacts, visibility suspension, idle suspension, and an impact safety cap.
...
- EditMode: `Water25D.Tests.EditMode`, 7 passed, 0 failed.
- PlayMode: `Water25D.Tests.PlayMode`, 1 passed, 0 failed.
- Visual validation scene: `Assets/Water25D/Samples/Water25D_VisualValidation.unity`. The retained [oblique capture](Validation/water25d-saved-scene-oblique.png) confirms the XZ top surface, XY front surface, waterline seam, and analytical ambient motion.
